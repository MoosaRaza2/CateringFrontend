    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      <div className='navbar' style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
        ...
        <div >
            ...
            <Button style={{ color: "white", borderColor: "white",marginRight:"48vmax" }} variant="outline-primary"> <a style={{textDecoration:"none",color:"white"}} href="/">Welcome Admin</a> </Button> 
